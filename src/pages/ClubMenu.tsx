    ...
    <div className="min-h-screen">
      <section className="relative h-[300px] overflow-hidden md:h-[420px]">
        ...
        <div className="absolute bottom-6 left-4 right-4 md:bottom-10 md:left-10">
          <h1 className="animate-scale-in text-3xl font-bold text-foreground md:text-5xl">
            {club.name}
          </h1>
          <p className="mt-2 max-w-2xl text-sm text-muted-foreground md:text-lg">
            {club.description}
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 pb-16 pt-10 md:px-6 md:pt-14">
        <div className="mb-10 text-center md:mb-14">
          <h2 className="animate-scale-in text-2xl font-bold text-foreground md:text-3xl">
